...
"$TC/bin/clang++" --target=aarch64-none-linux-android24 --sysroot="$TC/sysroot" \
    ...
    -o "$OUT/pennyspeak.cpp.o" -c "$HERE/pennyspeak.cpp"
...
"$TC/bin/clang++" --target=aarch64-none-linux-android24 --sysroot="$TC/sysroot" \
    ...
    "$OUT/pennyspeak.cpp.o" "$OUT/c-api.cc.o" -o "$OUT/pennyspeak" \
...
"$TC/bin/llvm-strip" -o "$OUT/pennyspeak-stripped" "$OUT/pennyspeak"
echo "built: $OUT/pennyspeak and $OUT/pennyspeak-stripped"
